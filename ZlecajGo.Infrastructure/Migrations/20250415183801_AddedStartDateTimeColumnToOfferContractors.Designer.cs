...
namespace ZlecajGo.Infrastructure.Migrations
{
    ...
    [Migration("20250415183801_AddedStartDateTimeColumnToOfferContractors")]
    partial class AddedStartDateTimeColumnToOfferContractors
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ZlecajGo.Domain.Entities.Chat", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("Chats", t =>
                        {
                            t.HasCheckConstraint("CK_Chat_UserOrder", "\"User1Id\" < \"User2Id\"");
                        });
                });

            modelBuilder.Entity("ZlecajGo.Domain.Entities.Message", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ZlecajGo.Domain.Entities.OfferContractor", b =>
                {
            ...
            modelBuilder.Entity("ZlecajGo.Domain.Entities.Chat", b =>
                {
                    b.HasOne("ZlecajGo.Domain.Entities.User", "User1")
                        .WithMany("ChatsAsUser1")
                        .HasForeignKey("User1Id")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("ZlecajGo.Domain.Entities.User", "User2")
            ...
            modelBuilder.Entity("ZlecajGo.Domain.Entities.Message", b =>
                {
                    b.HasOne("ZlecajGo.Domain.Entities.Chat", "Chat")
                        .WithMany("Messages")
                        .HasForeignKey("ChatId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("ZlecajGo.Domain.Entities.User", "Sender")
